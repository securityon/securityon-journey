---
title: "학회 논문 투고를 목표로"
description: "석사과정의 연구를 발전시켜 AI 분야 주요 학회에 논문을 제출하는 것을 목표로 합니다."
lang: ko
...
석사과정에서 공부와 연구를 이어가며, 연구 결과를 논문으로 발전시켜
AI 분야의 주요 학회에 제출하는 것을 하나의 목표로 삼고 있습니다.

아래는 현재 참고하고 있는 학회 목록입니다.
연구가 진행되면서 실제 연구 주제와 결과에 적합한 학회를 찾아
구체적인 투고 목표를 정해갈 예정입니다.
...
| 삼성논문상 | 삼성논문상 (Artificial Intelligence 분야)                                                |

이 목록을 출발점으로 삼되, 학회 자체를 목표로 연구 방향을 맞추기보다는
먼저 연구의 완성도를 높이고 그 결과에 가장 적합한 학회를 선택하고자 합니다.
